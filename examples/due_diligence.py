...
def run_due_diligence(company: str, industry: str) -> DueDiligenceReport:
    ...
    return DueDiligenceReport(
        company=company,
        market_position={"summary": market.summary, "findings": market.key_findings},
        technology={"summary": tech.summary, "findings": tech.key_findings},
        team={"summary": team.summary, "findings": team.key_findings},
        risks={"summary": risks.summary, "findings": risks.key_findings},
        opportunities={"summary": opps.summary, "findings": opps.key_findings},
